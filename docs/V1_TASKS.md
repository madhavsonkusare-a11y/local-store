...
| E03 | PARTIAL | Bootstrap journal, collision preflight, rootfs verification and bounded import are implemented. Post-import verification requires the exact distro on WSL2, matching in-distro ownership token, all five locked package versions, and ready Docker/Compose before Verified. Explicit uncertain-import recovery, prerequisites/elevation and clean-machine proof remain. | E02 |
