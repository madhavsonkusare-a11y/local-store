...
| E03 | PARTIAL | Bootstrap journal now reserves immutable distro/data/payload ownership and permits only reserved → imported → verified transitions; corrupt, oversized and conflicting state refuses replacement. Add WSL inventory decoding/collision checks, authenticated payload staging, import/verification, recovery and clean-machine proof. | E02 |
