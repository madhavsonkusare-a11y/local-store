...
| E03 | PARTIAL | Bootstrap journal reserves immutable distro/data/payload ownership. Preflight refuses collisions; rootfs is verified before reservation and bounded import. Import success advances to Imported; failure/truncation/timeout retains Reserved for recovery and never unregisters. Post-import identity/daemon verification, recovery execution and clean-machine proof remain. | E02 |
